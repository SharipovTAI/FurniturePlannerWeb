...
function updateInspector() {
  ...
  fieldHeight.value = obj.length || obj.height;
  ...
  const updateField = (field) => {
    return () => {
      ...
      switch (field) {
        ...
        case 'height': obj.height = parseFloat(fieldLength.value) || obj.height; break;
        case 'length': obj.length = parseFloat(fieldHeight.value) || obj.length; break;
